          ...
          <Row className="mb-5">
            ...
            <Col md={9}>
              ...
              <p className="text-center text-lg-right">
                Lorem ipsum dolor sit amet, consectet adop adipisicing elit, sed
                do eiusmod temporara incididunt ugt labore.
              </p>
            </Col>
          </Row>
